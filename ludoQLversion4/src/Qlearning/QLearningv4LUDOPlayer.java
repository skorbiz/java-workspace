...
public class QLearningv4LUDOPlayer implements LUDOPlayer {
	...
	private static int nRewards = 17;
	...
	//::::: CONSTRUCTOR :::::::::::::::::::::::::::::::::::::::
	//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	public QLearningv4LUDOPlayer(LUDOBoard aLUDOBoard)
	{
		board = aLUDOBoard;
	...
	{	
		if(lastState != -1)
			if(lastAction != -1)
			{
				...
				//QTable.get(lastState)[lastAction] += (0.5 / alpha.get(lastState)[lastAction])*(reward + gamma*QTableMax-QTable.get(lastState)[lastAction]);
				//QTable.get(lastState)[lastAction] += 0.1*(reward + gamma*QTableMax-QTable.get(lastState)[lastAction]);
	...
	public void updateQTableWithCompletion(double reward)
	{
		if(reward == 3)
		{
			...
			QTable.get(lastState)[lastAction] += 0.001*(reward*1000 + gamma*QTableMax-QTable.get(lastState)[lastAction]);
		}
	}
	...
	private double calcReward(int action)
	{
		...
		reward += rewardDistanceToGoal(current_board);
//		reward += rewardBricksCompleted(current_board);
		//reward += rewardIsDone();
...
//    	
//    	if(lastStateBinary[0 + offset] == 1)
//    		reward += 0.5;
//    	if(lastStateBinary[1 + offset] == 1)
//    		reward += 2;
//    	if(lastStateBinary[2 + offset] == 1)
//    		reward += -3;
//    	if(lastStateBinary[3 + offset] == 1)
//    		reward += 1;
//    	if(lastStateBinary[4 + offset] == 1)
//    		reward += 0.5;
//    	if(lastStateBinary[5 + offset] == 1)
//    		reward += -0.5;
//    	if(lastStateBinary[6 + offset] == 1)
//    		reward += -0.4;
//    	if(lastStateBinary[7 + offset] == 1)
//    		reward += 0.4;
//    	if(lastStateBinary[8 + offset] == 1)
//    		reward += -0.2;
//    	if(lastStateBinary[9 + offset] == 1)
//    		reward += 0.2;
//    	if(lastStateBinary[10 + offset] == 1)
//    		reward += -0.2;
//    	if(lastStateBinary[11 + offset] == 1)
//    		reward += 0.2;
//    	if(lastStateBinary[12 + offset] == 1)
//    		reward += 0.1;
//    	if(lastStateBinary[13 + offset] == 1)
//    		reward += 0.4;
//    	if(lastStateBinary[14 + offset] == 1)
//    		reward += 0.8;
	...
	public void play() 
	{
		board.print("Johan Laursens player playing");
		board.rollDice();
		...
		else if(board.isDone(board.getMyColor()))
		{	System.out.println("test4");
			updateQTable(lastState, lastAction);
		}
